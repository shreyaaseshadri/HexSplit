...
* -fn, --folder_name : User specified name to store created files (tripartitions, maxmimum liklihood and bootstrap trees).
...
### Running Software
  ...
  3. Ensure your multiple sequence alignment is accessable
  4. Run wrapper script from terminal - an example is provided below

#### Input

python3 integration_file.py -msa /Users/shrey/Documents/integration/test_files/PGT_large.fa -rxml_loc /Users/shrey/standard-RAxML/raxmlHPC-AVX -fn PGT_long -nbs 100 -nthds 2
